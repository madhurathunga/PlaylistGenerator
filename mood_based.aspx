<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mood_based.aspx.cs" Inherits="Playlistgenerator.mood_based" %>
...
<div class="fixed-navbar">
    ...
    <div class="main-content">
        <div class="row small-spacing">
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="box-content card white">
                    <h4 class="box-title">Vibe onto songs based on mood</h4>
                    <table class="table">
                        <tr>
                            <td>
